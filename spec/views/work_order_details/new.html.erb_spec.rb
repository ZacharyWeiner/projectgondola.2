...
RSpec.describe "work_order_details/new", type: :view do
  before(:each) do
    assign(:work_order_detail, WorkOrderDetail.new(
      :smsid => "MyString",
      :buid => "MyString",
      :sms => "MyString",
  ...
  it "renders new work_order_detail form" do
    render

    assert_select "form[action=?][method=?]", work_order_details_path, "post" do
