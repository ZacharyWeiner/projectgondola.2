...
RSpec.describe "vehicle_infos/new", type: :view do
  before(:each) do
    assign(:vehicle_info, VehicleInfo.new(
      :year => 1,
      :make => "MyString",
      :model => "MyString",
  ...
  it "renders new vehicle_info form" do
    render

    assert_select "form[action=?][method=?]", vehicle_infos_path, "post" do
