class TechniciansController < ApplicationController
  ...
  private
    ...
    def technician_params
      params.require(:technician).permit(:mso_tech_id, :last_background_check, :gchat_id, :is_active, :home_phone, :cell_phone, :last_drug_test, :internal_tech_id, :company_info_id)
    end
end
